...
public class ChatService {
  ...
  public String chat(final ChatClient chatClient, final String input, final String ragArguments) {
    ...
    return chatClient
        ...
        .system(STR."""
                ...
                You should use the following position of your party and must include typical slogans and statements from it (if your opponent says things otherwise, argue strongly and possibly redirect the discussion back to the slogan you stand for):
                \{ragArguments}
                """)
        .call()
        .content();
